...
try :
    PATH = "./trained_model/resnet_encoder_unet.pth" if hyper == "resnet" else "./trained_model/UNet_trained_model.pth"
...
torch.save(model.state_dict(), savepath1 + "_final.pth")
